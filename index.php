                        ...
                        <div class="text-inner">
                            <div class="row">
                                <div class="col-lg-7 col-12">
                                    <div class="hero-text">
                                        <h1><span>UP TO 50% OFF </span>Hot Seller Now</h1>
                                        <p>Toughest case on the market now <br> Prettiest Case <br> Tough as rock</p>
                                        <div class="button">
                                                ...
                                                <div class="single-product">
                                                    <div class="product-img">
                                                        <a href="product-details.html">
                                                            <img class="default-img" src="phone_cases_img/<?= $product['p_img'] ?>" alt="#">
<!--                                                            <img class="hover-img" src="phone_cases_img/--><?//= $product['p_img'] ?><!--" alt="#">-->
                                                        </a>
                                                    ...
                                                    <div class="product-content">
                                                        ...
                                                        <div class="product-price">
                                                            <span>&dollar;<?= $product['p_price'] ?></span>
                                                        </div>
                                                    </div>
                                                </div>
                                            </div>
                    ...
                    <div class="owl-carousel popular-slider">
                        ...
                        <div class="single-product">
                            ...
                            <div class="product-content">
                                <h3><a href="product-details.html"><?= $product['p_name'] ?></a></h3>
                                <div class="product-price">
                                    <span class="old">&dollar;<?= $product['p_price'] ?></span>
                                    <span>&dollar;<?= $product['p_price'] ?></span>
                                </div>
                            </div>
                        </div>
            ...
            <div class="container-fluid">
                <div class="row">
                    <div class="col-lg-6 col-12 padding-right">
                        <div class="image">
                            <img src="images/deal_of_day.jpg" alt="#">
                        </div>
                    </div>
