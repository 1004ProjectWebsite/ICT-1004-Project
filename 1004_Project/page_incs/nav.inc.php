<nav class="navbar navbar-expand-sm navbar-light text-right" id="navbar" >
    <a class="navbar-brand" href="../pages/home.php"><img src="../images/phonix_logo_black.png" alt="phonix" height="40"></a>
    ...
    <div class="collapse navbar-collapse " id="navbarSupportedContent">
        <ul class="navbar-nav ">
            ...
            <li class="nav-item dropdown">
                <a class="nav-link dropdown-toggle" href="#" id="navbarDropdowns" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false" aria-label="navbarDropdown">
                    Shop
                </a>
        ...
        <ul class="navbar-nav ml-auto">
            ...
            if (isset($_SESSION["loggedin"]) && $_SESSION["loggedin"] === true) { //Means user is logged in display logout
                ...
                <li class="nav-item center dropdown">
                    <a class="nav-link dropdown-toggle" href="#" id="navbarDropdown" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false" aria-label="navbarDropdown">
